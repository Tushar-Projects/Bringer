...
class BringerCliTests(unittest.TestCase):
    def setUp(self):
        ...
        self.hardware_detector.select_model.return_value = "qwen2.5-7b"
    ...
    def test_default_mode_shows_minimal_startup_and_exit(
        ...
        self.assertIn("Model: qwen2.5-7b (GPU)", text_calls)
    ...
    def test_exit_triggers_shutdown(self, _input, load_runtime_modules, _check_lms):
        ...
        self.lm_manager.ensure_ready.assert_called_once_with("qwen2.5-7b")
    ...
    def test_run_status_prints_index_and_model_status(self, vector_store_cls, lm_manager_cls, console_print):
        ...
        lm_manager = Mock()
        lm_manager.get_loaded_models.return_value = ["qwen2.5-7b"]
        ...
        self.assertIn("- qwen2.5-7b", text_calls)
